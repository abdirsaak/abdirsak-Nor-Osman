        ...
        <div className="relative w-screen h-screen bg-black overflow-hidden font-sans">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center w-full h-full text-white">
                <div className="text-center">
                    ...
                    <button onClick={() => setPage('projects')} className="mt-8 px-8 py-3 border border-orange-400 text-orange-400 rounded-full hover:bg-orange-400 hover:text-black transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-orange-300">
                        Explore My Work
                    </button>
                </div>
            </div>
